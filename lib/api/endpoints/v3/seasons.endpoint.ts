...
import type { TmdbAccountSeasonStatus } from '~/models/tmdb-account.model';
...
import type { TmdbVideo } from '~/models/tmdb-entity.model';
import type { TmdbImageShort } from '~/models/tmdb-image.model';
import type { TmdbProviders } from '~/models/tmdb-provider.model';
import type { TmdbSeasonExtended } from '~/models/tmdb-season.model';

import type { TmdbTranslations } from '~/models/tmdb-translation.model';

import { TmdbClientEndpoint, type TmdbParamPagination } from '~/models/tmdb-client.model';

...
import type { TmdbSearchCollection } from '~/models/tmdb-collection.model';

import type { TmdbCompanyShort } from '~/models/tmdb-company.model';
import type { TmdbKeyword } from '~/models/tmdb-entity.model';
import type { TmdbMovieShort } from '~/models/tmdb-movie.model';
import type { TmdbPersonKnownFor } from '~/models/tmdb-person.model';
import type { TmdbShowShort } from '~/models/tmdb-show.model';
